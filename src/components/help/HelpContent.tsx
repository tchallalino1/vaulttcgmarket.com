...
const faqSections: { category: string; icon: React.ReactNode; items: FAQItem[] }[] = [
  {
    ...
    items: [
      { question: 'How do I place an order?', answer: 'Browse our marketplace, add items to your cart, and proceed to checkout. You can pay with Apple Pay, Cash App, Chime, Bitcoin, Zelle, Wise, Bank Transfer, Revolut, or GCash.' },
      ...
      { question: 'What payment methods do you accept?', answer: 'We accept Apple Pay, Cash App, Chime, Bitcoin, Zelle, Wise Transfer, Bank Transfer, Revolut, and GCash. All payments are securely processed with 256-bit SSL encryption.' },
    ],
  },
  {
