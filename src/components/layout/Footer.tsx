        ...
        <div className="border-t border-gray-800 py-6">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="flex items-center gap-3">
              <span className="rounded border border-gray-700 bg-white px-2 py-0.5 text-xs font-bold text-gray-900">VISA</span>
              <span className="rounded border border-gray-700 bg-white px-2 py-0.5 text-xs font-bold text-gray-900">MC</span>
              <span className="rounded border border-gray-700 bg-white px-2 py-0.5 text-xs font-bold text-gray-900">AMEX</span>
              <span className="rounded border border-gray-700 bg-white px-2 py-0.5 text-xs font-bold text-blue-900">PayPal</span>
            </div>
