    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="max-w-3xl space-y-8">
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">We accept Apple Pay, Cash App, Chime, Bitcoin, Zelle, Wise Transfer, Bank Transfer, Revolut, and GCash as displayed at checkout. All payments are processed securely. Vault TCG Market holds payment until the buyer confirms receipt.</p>
        </section>
