...
const categories = [
  { label: 'All', value: '' },
  { label: 'Booster Boxes', value: 'booster box' },
  { label: 'Elite Trainer Boxes', value: 'elite trainer' },
  { label: 'Booster Bundles', value: 'booster bundle' },
  { label: 'Collection Boxes', value: 'collection' },
...
export default function SealedPage() {
  ...
  useEffect(() => {
    fetch('/api/products')
      .then(r => r.json())
      .then((data: Product[]) => {
        setProducts(data.filter(p => p.productType === 'sealed'));
        setLoading(false);
      })
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <p className="text-sm text-gray-500 mb-8">{filtered.length} sealed products available</p>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          <p className="text-gray-500 text-lg">No sealed products found for this category.</p>
