...
const faqCategories = [
  {
    ...
    questions: [
      { q: 'How do I place an order?', a: 'Browse our marketplace, add items to your cart, and proceed to checkout. You can pay with credit cards, PayPal, or other available payment methods.' },
      ...
      { q: 'What payment methods do you accept?', a: 'We accept Visa, Mastercard, American Express, Discover, and PayPal. All transactions are securely processed.' },
      { q: 'Is my payment information secure?', a: 'Yes. All payments are processed through encrypted, PCI-compliant payment processors. We never store your full card details.' },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'How do I get paid?', a: 'Payments are deposited directly to your connected bank account or PayPal within 2-3 business days of delivery confirmation.' },
    ],
  },
  {
    title: 'Account',
