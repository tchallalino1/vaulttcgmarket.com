...
export const seedProducts: Product[] = [
  ...
  // === SEALED PRODUCTS (Real API images from Pokémon TCG API) ===
  {
    id: 'prod-023',
    ...
    currency: 'USD',
    stock: 8,
    images: ['https://images.pokemontcg.io/swsh7/swsh7-s7_hires.png'],
    condition: 'Factory Sealed',
    language: 'English',
    set: 'Evolving Skies',
    setSlug: 'evolving-skies',
  ...
  },
  {
    ...
    currency: 'USD',
    stock: 25,
    images: ['https://images.pokemontcg.io/sv3pt5/sv3pt5-s1_hires.png'],
    condition: 'Factory Sealed',
    language: 'English',
    set: 'Pokémon 151',
    setSlug: 'pokemon-151',
  ...
  },
  {
    ...
    description: 'Factory sealed Crown Zenith booster pack. 10 cards per pack from the Crown Zenith expansion.',
    productType: 'sealed',
    category: 'sealed',
    price: 5.29,
    currency: 'USD',
    stock: 50,
    images: ['https://images.pokemontcg.io/swsh12pt5/swsh12pt5-s1_hires.png'],
    condition: 'Factory Sealed',
    language: 'English',
    set: 'Crown Zenith',
    setSlug: 'crown-zenith',
  ...
  },
  {
    ...
    slug: 'celebrations-booster-pack',
    description: 'Factory sealed Celebrations booster pack. 10 cards celebrating 25 years of Pokémon.',
    productType: 'sealed',
    category: 'sealed',
    price: 7.49,
    currency: 'USD',
    stock: 30,
    images: ['https://images.pokemontcg.io/cel25/cel25-s20_hires.png'],
    condition: 'Factory Sealed',
    language: 'English',
    set: 'Celebrations',
  ...
  {
    id: 'prod-027',
    name: 'Black & White Booster Box',
    slug: 'black-white-booster-box',
    description: 'Factory sealed Black & White booster box. 36 packs from the Black & White expansion.',
    productType: 'sealed',
    category: 'sealed',
    price: 2399.00,
    currency: 'USD',
    stock: 3,
    images: ['https://images.pokemontcg.io/bw1/bw1-s1_hires.png'],
    condition: 'Factory Sealed',
    language: 'English',
    set: 'Black & White',
    setSlug: 'black-white',
  ...
  {
    id: 'prod-028',
    name: 'Emerging Powers Booster Box',
    slug: 'emerging-powers-booster-box',
    description: 'Factory sealed Emerging Powers booster box. 36 packs from the Black & White era.',
    productType: 'sealed',
    category: 'sealed',
    price: 2170.09,
    currency: 'USD',
    stock: 4,
    images: ['https://images.pokemontcg.io/bw2/bw2-s1_hires.png'],
    condition: 'Factory Sealed',
    language: 'English',
    set: 'Emerging Powers',
    setSlug: 'emerging-powers',
    createdAt: '2024-02-10T11:30:00Z',
    updatedAt: '2024-03-10T14:15:00Z',
  },
  {
    id: 'prod-037',
    name: 'Next Destinies Booster Box',
    slug: 'next-destinies-booster-box',
    description: 'Factory sealed Next Destinies booster box. 36 packs from the Black & White era.',
    productType: 'sealed',
    category: 'sealed',
    price: 2888.85,
    currency: 'USD',
    stock: 2,
    images: ['https://images.pokemontcg.io/bw4/bw4-s2_hires.png'],
    condition: 'Factory Sealed',
    language: 'English',
    set: 'Next Destinies',
    setSlug: 'next-destinies',
    createdAt: '2024-03-01T10:00:00Z',
    updatedAt: '2024-03-15T12:00:00Z',
  },
  {
    id: 'prod-038',
    name: 'Dragons Exalted Booster Box',
    slug: 'dragons-exalted-booster-box',
    description: 'Factory sealed Dragons Exalted booster box. 36 packs from the Black & White era.',
    productType: 'sealed',
    category: 'sealed',
    price: 4269.94,
    currency: 'USD',
    stock: 2,
    images: ['https://images.pokemontcg.io/bw6/bw6-s1_hires.png'],
    condition: 'Factory Sealed',
    language: 'English',
    set: 'Dragons Exalted',
    setSlug: 'dragons-exalted',
    createdAt: '2024-03-01T10:00:00Z',
    updatedAt: '2024-03-15T12:00:00Z',
  },
  {
    id: 'prod-039',
    name: 'Plasma Storm Booster Box',
    slug: 'plasma-storm-booster-box',
    description: 'Factory sealed Plasma Storm booster box. 36 packs from the Black & White era.',
    productType: 'sealed',
    category: 'sealed',
    price: 6609.50,
    currency: 'USD',
    stock: 1,
    images: ['https://images.pokemontcg.io/bw8/bw8-s2_hires.png'],
    condition: 'Factory Sealed',
    language: 'English',
    set: 'Plasma Storm',
    setSlug: 'plasma-storm',
    createdAt: '2024-03-01T10:00:00Z',
    updatedAt: '2024-03-15T12:00:00Z',
  },
  {
    id: 'prod-040',
    name: 'Mysterious Treasures Booster Box',
    slug: 'mysterious-treasures-booster-box',
    description: 'Factory sealed Mysterious Treasures booster box. 36 packs from the Diamond & Pearl era.',
    productType: 'sealed',
    category: 'sealed',
    price: 6339.94,
    currency: 'USD',
    stock: 1,
    images: ['https://images.pokemontcg.io/dp2/dp2-s1_hires.png'],
    condition: 'Factory Sealed',
    language: 'English',
    set: 'Mysterious Treasures',
    setSlug: 'mysterious-treasures',
    createdAt: '2024-03-01T10:00:00Z',
    updatedAt: '2024-03-15T12:00:00Z',
  },
